...
const filterTypes = ['readable', 'writeable','map','object','any', 'bytes'];
...
function _initValue(type) {
  ...
  if (type === '[ string ]') {
    return `${_setExtendFunc(type)}[]string{})`;
  }
  return `&${type}{}`;
}
...
module.exports = {
  _name, _string, _type, _format, _initValue, _structType, _avoidReserveName, 

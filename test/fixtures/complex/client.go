...
func (s Err1) String() string {
  return dara.Prettify(s)
}

func (s Err1) GoString() string {
  return s.String()
}

func (s *Err1) SetData(v map[string]*string) *Err1 {
  s.Data = v
  return s
}
...
func (s Err2) String() string {
  return dara.Prettify(s)
}

func (s Err2) GoString() string {
  return s.String()
}

func (s *Err2) SetAccessErrMessage(v string) *Err2 {
  s.AccessErrMessage = &v
  return s
}
...
func (client *Client) Complex1(request *ComplexRequest, client *source.Client) (_result *source.RuntimeObject, _err error) {
  ...
  for dara.ShouldRetry(_runtime.RetryOptions, retryPolicyContext) {
    ...
    _err = complex1_opResponse(request)
    if _err != nil {
      retriesAttempted++
      retryPolicyContext = &dara.RetryPolicyContext{
        RetriesAttempted: retriesAttempted,
...
func (client *Client) Complex3(request *ComplexRequest, name *string) (_result *ComplexRequest, _err error) {
  ...
  _result, _err = complex3_opResponse(response_, request)
  if _err != nil {
    return nil, _err
  }
...
func (client *Client) ReturnFunc2 () (_result map[string]interface{}) {
  ...
  if true {
    ...
    var body io.Reader
    _result = dara.ToMap(map[string]interface{}{
      "body": body,
    }, tmp)
    return _result
  }
...
func (client *Client) Error (e *dara.SDKError) (_result *dara.SDKError) {
  var tmp *dara.SDKError
  var c interface{}
  _result = e
  return _result
}
...
func complex1_opResponse (request *ComplexRequest)( _result *source.RuntimeObject, _err error) {
  if true && true {
    _result = nil
    return _result , _err
  } else if true || false {
...
func complex3_opResponse (response_ *dara.Response, request *ComplexRequest)( _result *ComplexRequest, _err error) {
  resp := response_
  req := &source.Request{
  ...
  _result = dara.Merge(request_.Query)
  return _result, _err
}
